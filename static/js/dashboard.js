(function() {
    ...
    items.forEach(function(el) {
        ...
        var value = Object.prototype.hasOwnProperty.call(mockData, key) ? mockData[key] : fallback;
        el.setAttribute('data-counter-target', String(value));
        el.textContent = '0';
    });
